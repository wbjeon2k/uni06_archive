...
private:
  ...
  // -------------------------------------------------------------------------
	...
	void Dijkstra(const string& airport, vector<double> &dist, vector<int>& parent);
	typedef AdjacencyListDirectedGraph<string, double>::Vertex vertex;
	typedef priority_queue< pair<double, string> , vector< pair<double, string > >, greater< pair<double, string> > > vertex_pq;
	typedef FlightMap::FlightGraph::VertexList VList;
	typedef FlightMap::FlightGraph::VertexItor VItor;
	typedef AdjacencyListDirectedGraph<string, double>::EdgeList EList;
